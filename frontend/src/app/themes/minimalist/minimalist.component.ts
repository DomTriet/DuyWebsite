...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-white text-gray-900 selection:bg-gray-900 selection:text-white pb-24">
      ...
      <header class="py-6 px-6 md:px-12 flex justify-between items-center border-b border-gray-200 sticky top-0 bg-white/95 backdrop-blur-md z-50 transition-all duration-300">
        <div class="text-2xl font-bold tracking-tight text-gray-900 font-mono">
